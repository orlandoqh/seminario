           ...
           try {
               ...
               rs=ps.executeQuery();
                 while(rs.next()){
                   ...
                   evt.setExpositor(rs.getString("expositor"));
                   evt.setFecha(rs.getString("fecha"));
                  evt.setHora(rs.getString("hora"));
                   evt.setCupo(rs.getInt("cupo"));
